 ...
 */
package com.safepay.pay.app.reconciliation;

import com.safepay.pay.app.reconciliation.biz.ReconciliationCheckBiz;
import com.safepay.pay.app.reconciliation.biz.ReconciliationFileDownBiz;
import com.safepay.pay.app.reconciliation.biz.ReconciliationFileParserBiz;
import com.safepay.pay.app.reconciliation.biz.ReconciliationValidateBiz;
import com.safepay.pay.app.reconciliation.utils.DateUtil;
import com.safepay.pay.app.reconciliation.utils.SpringContextUtil;
import com.safepay.pay.app.reconciliation.vo.ReconciliationInterface;
import com.safepay.pay.reconciliation.entity.RpAccountCheckBatch;
import com.safepay.pay.reconciliation.enums.BatchStatusEnum;
import com.safepay.pay.reconciliation.service.RpAccountCheckBatchService;
import com.safepay.pay.reconciliation.vo.ReconciliationEntityVo;
import com.safepay.pay.user.service.BuildNoService;
...
public class ReconciliationTask {
	...
	public static void main(String[] args) {
		...
		try {
			...
			LOG.error("safepay-app-reconciliation error:", e);
		}
