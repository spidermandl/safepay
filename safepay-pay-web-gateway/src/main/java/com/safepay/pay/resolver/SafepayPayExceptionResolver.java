package com.safepay.pay.resolver;/*
 * Copyright 2015-2102 .
 *
 ...
 *
 */
public class SafepayPayExceptionResolver implements HandlerExceptionResolver {

    private static final Logger LOG = LoggerFactory.getLogger(SafepayPayExceptionResolver.class);
