...
<div class="wrap_header">
  <div class="header clearfix">
    <div class="logo_panel clearfix">
      ...
      <div class="lg_txt">| SAFE Pay支付体验平台</div>
    </div>
    <div class="fr tip_panel">
      <div class="txt">欢迎使用 SAFE Pay 支付付款</div>
      <a href="">常见问题</a>
    </div>
  </div>
</div>
  ...
  <div class="bd">
    <ul class="payment">
      <li><img src="${path}images/weixin.png" alt="微信支付" />
        <form action="${path}safepayPay/scanPay" method="post">
...
<div class="footer w100">
  ...
  <div class="copyright">Copyright © 2015-2016 SAFE Payment</div>
